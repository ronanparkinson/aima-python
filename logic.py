...
def occur_check(var, x, s):#var = v_0 s = (v_0; hasblueEyes(Frank)} x: hasblueEyes(Frank)
...
def unify_mm(x, y, s={}):
    ...
    set_eq = extend(s, x, y) #set_eq {v_0: hasblueEyes(Frank)}
    s = set_eq.copy()
    while True:
        trans = 0
