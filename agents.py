...
class Environment:
    ...
    def add_thing(self, thing, location=None):
        ...
        if thing in self.things:
            ...
            #print("test")
            thing.location = location if location is not None else self.default_location(self.things)
...
class XYEnvironment(Environment):
    ...
    def execute_action(self, agent, action):
        ...
        if action == 'TurnRight':
            ...
            agent.bump = self.move_to(agent, agent.irection.move_forward(agent.location))
        elif action == 'Grab':
...
environment = TrivialVacuumEnvironment
agentsList = [TableDrivenVacuumAgent]
result = compare_agents(environment, agentsList, n=10, steps=20)

performance_TableDrivenVacuumAgent = result[0][1]

#print("Test", performance_TableDrivenVacuumAgent)
